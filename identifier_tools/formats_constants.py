...
ECB_NATIONAL_IDENTIFIERS_REGISTERS = {
    ...
    "HK_CR_CD": (
        "https://www.icris.cr.gov.hk/csci/login_i.do?loginType=iguest&OPT_01=1&OPT_02=1&OPT_03=1&OPT_04=1&OPT_05=1&OPT_06=1&OPT_07=1&OPT_08=1&OPT_09=1",  # noqa: E501
...
ECB_NATIONAL_IDENTIFIERS = {
    ...
    "LV_FON_CD": "(^LVAF[0-9]{3}[AB0-9]{1}[0-9]{2}$)|(^LVIF[0-9]{3}[ABCDEF0-9]{1}[0-9]{2}$)|(^LVB[0-9]{6}$)|(^LVVF[0-9]{6}$)|(^LV[0-9]{11}$)",  # noqa: E501
    "LV_NBR_CD": "^[0-9]{11}$",
    "LV_VAT_CD": "^LV[0-9]{11}$",
    "MC_CIB": "^[0-9]{5}$",
